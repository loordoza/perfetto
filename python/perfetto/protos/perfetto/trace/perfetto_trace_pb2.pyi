...
class Cfg80211ScanDoneFtraceEvent(_message.Message):
    __slots__ = ["aborted", "ie", "n_channels", "no_cck", "scan_start_tsf", "tsf_bssid", "wdev_id", "wiphy_mac"]
    ABORTED_FIELD_NUMBER: _ClassVar[int]
    IE_FIELD_NUMBER: _ClassVar[int]
    NO_CCK_FIELD_NUMBER: _ClassVar[int]
    N_CHANNELS_FIELD_NUMBER: _ClassVar[int]
    SCAN_START_TSF_FIELD_NUMBER: _ClassVar[int]
    TSF_BSSID_FIELD_NUMBER: _ClassVar[int]
    WDEV_ID_FIELD_NUMBER: _ClassVar[int]
    WIPHY_MAC_FIELD_NUMBER: _ClassVar[int]
    aborted: int
    ie: int
    n_channels: int
    no_cck: int
    ...
    wdev_id: int
    wiphy_mac: int
    def __init__(self, n_channels: _Optional[int] = ..., ie: _Optional[int] = ..., wdev_id: _Optional[int] = ..., wiphy_mac: _Optional[int] = ..., no_cck: _Optional[int] = ..., aborted: _Optional[int] = ..., scan_start_tsf: _Optional[int] = ..., tsf_bssid: _Optional[int] = ...) -> None: ...
...
class DrvHwScanFtraceEvent(_message.Message):
    __slots__ = ["p2p", "sdata", "vif_name", "vif_type", "wiphy_name"]
    P2P_FIELD_NUMBER: _ClassVar[int]
    SDATA_FIELD_NUMBER: _ClassVar[int]
    VIF_NAME_FIELD_NUMBER: _ClassVar[int]
    VIF_TYPE_FIELD_NUMBER: _ClassVar[int]
    WIPHY_NAME_FIELD_NUMBER: _ClassVar[int]
    p2p: int
    sdata: int
    vif_name: str
    vif_type: int
    wiphy_name: str
    def __init__(self, wiphy_name: _Optional[str] = ..., vif_type: _Optional[int] = ..., sdata: _Optional[int] = ..., p2p: _Optional[int] = ..., vif_name: _Optional[str] = ...) -> None: ...
...
class FtraceEvent(_message.Message):
    ...
    CFG80211_SCAN_DONE_FIELD_NUMBER: _ClassVar[int]
    ...
    DRV_HW_SCAN_FIELD_NUMBER: _ClassVar[int]
    ...
    cfg80211_scan_done: Cfg80211ScanDoneFtraceEvent
    ...
    drv_hw_scan: DrvHwScanFtraceEvent
